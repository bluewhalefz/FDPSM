...
wget -O data/annovar/humandb/hg38_phastConsElements100way.txt.gz https://zenodo.org/records/15049531/files/hg38_phastConsElements100way.txt.gz?download=1
